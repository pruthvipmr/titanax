...
def evaluate_model(eval_step_fn, state: tx.TrainState, eval_loader, max_eval_steps: int = None):
    ...
    return {
        ...
        "eval_accuracy": total_acc / num_steps
    }
...
def main():
    ...
    if args.devices == "auto":
        ...
        if jax.device_count() == 1:
            mesh_spec = tx.MeshSpec(devices=None, axes=("data",))  # None means use all available
        else:
        ...
        try:
            ...
            mesh_spec = tx.MeshSpec(devices=args.devices if args.devices != "auto" else None, axes=("data",))
    ...
    for step in range(1, args.steps + 1):
        ...
        if step % args.eval_every == 0 or step == args.steps:
            eval_metrics = evaluate_model(eval_step, state, test_loader, max_eval_steps=50)
