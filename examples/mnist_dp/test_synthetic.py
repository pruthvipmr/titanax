...
def main():
    ...
    train_loader = SyntheticMNISTLoader(
        batch_size=args.batch_size, num_batches=200, seed=42
    )
    test_loader = SyntheticMNISTLoader(
        batch_size=args.batch_size, num_batches=20, seed=123
    )
        ...
        for batch in train_loader:
            ...
            if step % args.eval_every == 0 or step == args.steps:
                eval_metrics = evaluate_model(
                    eval_step, state, test_loader, max_eval_steps=10
                )
