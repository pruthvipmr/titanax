...
class TestErrorHandling:
    ...
    def test_keyboard_interrupt_handling(self):
        ...
        interrupt_calls = [call for call in logger.log_scalar.call_args_list 
                          if call[0][0] == "training/interrupted"]
        assert len(interrupt_calls) > 0, f"Expected interrupted log, got calls: {logger.log_scalar.call_args_list}"
