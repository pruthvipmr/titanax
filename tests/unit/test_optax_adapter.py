...
class TestOptaxAdapter:
    ...
    def test_apply_gradients_fixed_lr(self):
        ...
        base_opt = optax.sgd(
            learning_rate=1.0
        )  # Use learning rate of 1.0 for easy testing
...
class TestOptimizerFactories:
    ...
    def test_adamw_custom_params(self):
        ...
        optimizer = adamw(learning_rate=1e-3, b1=0.95, b2=0.999, weight_decay=1e-3)
...
class TestLearningRateSchedules:
    ...
    def test_exponential_schedule(self):
        ...
        schedule = exponential_schedule(
            init_value=1e-2, transition_steps=10, decay_rate=0.9
        )
