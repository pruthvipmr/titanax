...
def adamw(
    ...
    **kwargs,
    ...
    try:
        ...
        return OptaxAdapter(
            optimizer=base_optimizer, learning_rate=learning_rate, name="adamw"
        )
...
def sgd(
    ...
    **kwargs,
    ...
    try:
        ...
        return OptaxAdapter(
            optimizer=base_optimizer, learning_rate=learning_rate, name="sgd"
        )
...
def adam(
    ...
    **kwargs,
    ...
    try:
        ...
        return OptaxAdapter(
            optimizer=base_optimizer, learning_rate=learning_rate, name="adam"
        )
...
def exponential_schedule(
    init_value: float, transition_steps: int, decay_rate: float, staircase: bool = False
) -> Callable[[int], float]:
    ...
    Returns:
        Learning rate schedule function
    """
    return optax.exponential_decay(init_value, transition_steps, decay_rate, staircase)
